...
class ProductController extends Controller
{
    public function create()
    {
        ...
        return view('admin.product.create',compact('all_category','all_subcategory','all_childcategory','products'));
    }
       ...
       public function show($id)
    {
        ...
        return view('admin.product.edit', compact('product', 'all_category', 'all_subcategory', 'all_childcategory'));
    }
