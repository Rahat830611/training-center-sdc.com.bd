					                        ...
					                        <div class="modal-dialog" role="document">
					                            <div class="modal-content">
					                                ...
					                                <div class="modal-body">
					                                   	<form action="{{url('admin/post/childcategory')}}" method="POST" enctype="multipart/form-data">
					                                   		@csrf
										...
										<table id="usertable" class="table table-bordered table-striped">
											...
											<tbody>
												...
												<tr>
													...
													<td><img src="{{asset('uploads/childcategory')}}/{{$category->image}}" alt="" width="80px;"></td>
													<td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	@if($childcategory->status==1)
                <a href="{{url('admin/childcategory/status')}}/{{$childcategory->id}}" class="btn btn-danger">Active</a>
                @else
                <a href="{{url('admin/childcategory/status')}}/{{$childcategory->id}}" class="btn btn-danger">Deactive</a>
                @endif
...
<div class="modal fade" id="deleteModal{{$childcategory->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="{{url('admin/childcategory/delete')}}/{{$childcategory->id}}" class="btn btn-danger">Delete</a>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
...
<div class="modal fade " id="editModal{{$childcategory->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              	<form action="{{url('admin/update/childcategory')}}" method="POST" enctype="multipart/form-data">
                       		@csrf
                <div class="form-group">
                	<label>Category Name:</label><br>
                ...
                <div class="form-group">
				   <label for="title">Sub-Category Name:</label>
	                <select name="subcategory_id" id="upsubcategory_id" class="form-control" style="width:100%;">
