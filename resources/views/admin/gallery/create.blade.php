    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <h6 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add Gallery</h6>
                <!--end::Actions-->
            </div>
            <!--end::Info-->
        </div>
                    ...
                    <div class="card card-custom">
					 	<div class="card-header">
						    <div class="card-title">
						   		<h3 class="card-label">Create New Gallery</h3>
						    </div>

						    <div class="card-toolbar">
							   	<ul class="nav nav-bold nav-pills ml-auto">
								    <li class="nav-item">
								    	<a href="{{url('admin/view/gallery')}}" class="btn btn-success">View</a>
								    </li>
							   </ul>
							</div>
						</div>
						  	...
						  	<div class="row">
						  		<div class="col-lg-10 m-auto">
						  			<form action="{{url('admin/post/gallery')}}" method="POST" enctype="multipart/form-data">
										...
										<!--    <label>Video</label>-->
										<!--    <textarea name="video" rows="3" cols="4" class="form-control" placeholder="Embeded Code"></textarea>-->
										<!--    <span class="form-text text-muted">Please enter your Video Embeded Code</span>-->
										<!--    @error('image')-->
										<!--    <div class="alert alert-danger">-->
										<!--    	<span>{{$message}}</span>-->
										<!--    </div>-->
...
<script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.js"></script>
 <script type="text/javascript">
    ...
    <script>
    	function myFunction()
    	{
    		var select = document.getElementById('gallery_type');
