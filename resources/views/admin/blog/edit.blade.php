    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <h6 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit Blog</h6>
                <!--end::Actions-->
            </div>
            <!--end::Info-->
        </div>
						  			...
						  			<form action="{{url('admin/update/blog')}}" method="POST" enctype="multipart/form-data">
										...
										<div class="form-group">
										    ...
										    <select class="form-control" name="type">
										        ...
										        <option value="career" {{$blog->type == 'career' ? 'selected' : ''}}>Career</option>
										    </select>
										</div>
										<div class="form-group">
										    <label>Short Description:</label>
										    <textarea name="short_description" id="" cols="4" rows="3" class="form-control">{{$blog->short_description}}</textarea>
										...
										<div class="form-group">
										    ...
										    <div class="custom-file">
												...
												<img src="{{asset('uploads/blog')}}/{{$blog->image}}" id="output_image" width="200px" style="padding-top: 5px;" />
											</div>
											@error('image')
										    <div class="alert alert-danger">
										    	<span>{{$message}}</span>
