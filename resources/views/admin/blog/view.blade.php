    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <h6 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Blog</h6>
                <!--end::Actions-->
            </div>
            <!--end::Info-->
        </div>
                    ...
                    <div class="card card-custom">
					 	<div class="card-header">
						    <div class="card-title">
						   		<h3 class="card-label">All Blog List</h3>
						    </div>

						    <div class="card-toolbar">
							   	<ul class="nav nav-bold nav-pills ml-auto">
								    <li class="nav-item">
								    	<a href="{{url('admin/blog/create')}}" class="btn btn-success">Add New Blog</a>
								    </li>
							   </ul>
							</div>
						</div>
										...
										<table id="usertable" class="table table-bordered table-striped">
											...
											<tbody>
												...
												<tr>
													...
													<td><img src="{{asset('uploads/blog')}}/{{$blog->image}}" alt="" width="80px;"></td>
													<td>
														@if($blog->status == 1)
														<a href="#statusModal{{$blog->id}}" data-toggle="modal" class="btn btn-danger"  ><i class="fas fa-toggle-off icon-md"></i>Deactive
					                                    </a>
														@else
														<a href="#statusModal{{$blog->id}}" data-toggle="modal" class="btn btn-success"  ><i class="fas fa-toggle-on icon-md"></i></i> Active
					                                    </a>
														@endif
													</td>
													<td>
					                                    <div class="dropdown">
														    ...
														    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
														        <a class="dropdown-item text-warning" href="{{url('admin/blog/edit')}}/{{$blog->id}}"><i class="flaticon2-edit icon-lg"></i>&nbsp;&nbsp;Edit
							                                    </a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	@if($blog->status == 1)
                <a href="{{url('admin/blog/status')}}/{{$blog->id}}" class="btn btn-danger">Active</a>
                @else
				<a href="{{url('admin/blog/status')}}/{{$blog->id}}" class="btn btn-danger">Deactive</a>
                @endif
