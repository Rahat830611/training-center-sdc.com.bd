										...
										<table id="usertable" class="table table-bordered table-striped">
											...
											@foreach($products as $product)
												<tr>
													...
													<td>{{$product->connect_subcategory->title??'Null'}}</td>
													...
													<td>
					                                    <div class="dropdown">
														    ...
														    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
														        ...
														        <a class="dropdown-item text-warning" href="{{ route('product_edit',$product->id) }}"><i class="flaticon2-edit icon-lg"></i>&nbsp;&nbsp;Edit
							                                    </a>
